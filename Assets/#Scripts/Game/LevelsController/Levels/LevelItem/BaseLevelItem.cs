...
public abstract class BaseLevelItem : MonoBehaviour, ILevelItem
{
    ...
    public void StartLevel(LevelItemConfigs levelItemConfigs)
    {
        ...
        _animalController = InstantiateAnimal(levelItemConfigs.AnimalController);
        _animalController.Initialize(_animalsContainer.GetSlotTailName(levelItemConfigs.AnimalType));
        
        SoundsController.Instance.Play(levelItemConfigs.OpenAnimalPhrase);
    }
    ...
    private AnimalController InstantiateAnimal(AnimalController animalControllerPrefab)
    {
